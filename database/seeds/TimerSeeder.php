...
class TimerSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('timers')->insert([
            ...
            ["id" => "1", "name" => "main activity 1", "active" => false, "count" => 1],
            ["id" => "2", "name" => "main activity 2", "active" => false, "count" => 2],
            ["id" => "3", "name" => "main activity 3", "active" => false, "count" => 3],
            ["id" => "4", "name" => "main activity 4", "active" => false, "count" => 4],


            ]),
            'sub_activities' => json_encode([
                ["id" => "1", "name" => "sub activity 1", "active" => false, "count" => 1],
                ["id" => "2", "name" => "sub activity 2", "active" => false, "count" => 2],
                ["id" => "3", "name" => "sub activity 3", "active" => false, "count" => 3],
                ["id" => "4", "name" => "sub activity 4", "active" => false, "count" => 4],


            ]),
            'scaled_activities' => json_encode([
                ["id" => "1", "name" => "scaled activity 1", "active" => false, "score" => 1],
                ["id" => "2", "name" => "scaled activity 2", "active" => false, "score" => 2],
                ["id" => "3", "name" => "scaled activity 3", "active" => false, "score" => 3],
                ["id" => "4", "name" => "scaled activity 4", "active" => false, "score" => 4],
            ]),
            'fixed_activities' => json_encode([
                ["id" => "1", "name" => "fixed activity 1", "active" => false, "options"=>
                [
                    ["id" => "1", "name" => "fixed activity 1 option 1", "active" => false, "count" => 1],
                    ["id" => "2", "name" => "fixed activity 1 option 2", "active" => false, "count" => 2],
                    ["id" => "3", "name" => "fixed activity 1 option 3", "active" => false, "count" => 3],
                ...
                [
                    ...
                    ["id" => "2", "name" => "fixed activity 2 option 2", "active" => false, "count" => 2],
                    ["id" => "3", "name" => "fixed activity 2 option 3", "active" => false, "count" => 3],
                    ["id" => "4", "name" => "fixed activity 2 option 4", "active" => false, "count" => 4],

                ]],

                ["id" => "3", "name" => "fixed activity 3", "active" => false, "options"=>
                [
                    ["id" => "1", "name" => "fixed activity 3 option 1", "active" => false, "count" => 1],
                    ["id" => "2", "name" => "fixed activity 3 option 2", "active" => false, "count" => 2],
                    ["id" => "3", "name" => "fixed activity 3 option 3", "active" => false, "count" => 3],
                    ["id" => "4", "name" => "fixed activity 3 option 4", "active" => false, "count" => 4],
            ...
            'experiments' => json_encode([
                ["id" => "1", "name" => "experiment 1", "active" => false, "count" => 1],
                ["id" => "2", "name" => "experiment 2", "active" => false, "count" => 2],
                ["id" => "3", "name" => "experiment 3", "active" => false, "count" => 3],
                ["id" => "4", "name" => "experiment 4", "active" => false, "count" => 4],
